...
$creatorID = $row['uid'];
$sqlUser = "SELECT * FROM mocktail_users WHERE id = $creatorID";
$stmtUser = $conn->prepare($sqlUser);
$stmtUser->execute();
$resultUser = $stmtUser->get_result();
$userRow = $resultUser->fetch_assoc();
$creatorName = $userRow['uname'];
$method = $row['method'];
$method = str_replace("\r\n", "<br>", $method);
?>
<html lang="en">
    ...
    <div class='form form-box'>
        ...
        <form>
            ...
            <div class='field input'>
                <label class="creator"><br></br><strong>Made By</strong> <br></br><?php echo $creatorName;?></label><br></br><br></br>
                <h2>Description</h2>
