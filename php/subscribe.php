    ...
    <div class='login'>
            <div class='form form-box'>
                ...
                <form action='includes/login_validation.php' method='post'>
                    <label for='desc'><strong>By joining our community, you gain access to regular updates on the latest mocktail news, insightful articles, and an ever-changing list of delicious mocktail recipes that are updated every season to keep your taste buds delighted and your gatherings refreshing.</strong></label>
